"""
============================================================
PhysioAI Pro V2 - Thoracic Extension Exercise Tracker
============================================================
PURPOSE:
    Tracks thoracic extension exercise reps using spine angle
    (shoulder-hip-knee). Monitors extension deviation from baseline.

ORIGIN:
    Integrated from ai-engine/exercises/thoracic_ext.py
============================================================
"""
